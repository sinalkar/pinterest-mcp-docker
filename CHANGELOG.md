...
- Add isolated hosted validation before Actions deployment
- Fix security scan handling before hosted deployment
- Fix formatting for hosted persistence CI checks
- Add Pinterest-first Keycloak broker and hosted persistence foundation
## [0.2.5] - 2026-08-29

### Changed

- Fix MCP path routing and comma-separated settings
- Update README badges and Docker Hub image documentation
## [0.2.4] - 2026-08-29
